  ...
  return (
    <>
      <Dialog open onOpenChange={(nextOpen) => !nextOpen && onClose()}>
        <DialogContent variant="form" zIndex="alert" className="max-w-[1120px]">
          ...
          <DialogBody>
            <div className="flex h-full min-h-0 flex-col gap-6">
              {/* 上半部分：表单字段 */}
              <div className="glass flex-shrink-0 space-y-6 rounded-xl border border-white/10 p-6">
                {/* 预设选择（仅新增时展示） */}
                {!isEditing && (
                  <div>
              ...
              <div className="glass flex min-h-0 flex-1 flex-col rounded-xl border border-white/10 p-6">
                ...
                <div className="flex min-h-0 flex-1 flex-col">
                  ...
                  {configError && (
                    <div className="mt-2 flex flex-shrink-0 items-center gap-2 text-sm text-red-500 dark:text-red-400">
                      <AlertCircle size={16} />
