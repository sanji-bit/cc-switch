...
/// 将 `/path/to/睿狐 CC Switch.app/Contents/MacOS/睿狐 CC Switch` 转换为 `/path/to/睿狐 CC Switch.app`
#[cfg(target_os = "macos")]
...
mod tests {
    ...
    fn test_get_macos_app_bundle_path_valid() {
        let exe_path = std::path::Path::new(
            "/Applications/睿狐 CC Switch.app/Contents/MacOS/睿狐 CC Switch",
        );
        let result = get_macos_app_bundle_path(exe_path);
        assert_eq!(
            result,
            Some(std::path::PathBuf::from("/Applications/睿狐 CC Switch.app"))
        );
    }
    ...
    fn test_get_macos_app_bundle_path_with_spaces() {
        let exe_path =
            std::path::Path::new(
                "/Users/test/My Apps/睿狐 CC Switch.app/Contents/MacOS/睿狐 CC Switch",
            );
        let result = get_macos_app_bundle_path(exe_path);
        assert_eq!(
            result,
            Some(std::path::PathBuf::from(
                "/Users/test/My Apps/睿狐 CC Switch.app"
            ))
        );
    }
